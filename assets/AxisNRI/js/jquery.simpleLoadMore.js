  ...
  $.fn.simpleLoadMore = function( options ) {
    ...
    $loadMore.each(function(i, el) {
      ...
      $btn.on('click', function(e) {
		...
		/*START : Code added by D for showing all item on click view all button on 16Aug2019 ====================================== */
		$updatedItems = $items.filter(':hidden').slice(0);
		$this.remove();
		/*END of code added by D for showing all item on click view all button on 16Aug2019 ====================================== */
