...
<div class="row">
<div class="col-md-12">
<img src="img/career.jpg" alt="" style="width:100%;"> 
</div>
</div>
</div>
<div class="container ">
...
<!-- <h2>Carrers</h2> -->
<h3>
                We are committed to hiring, developing, motivating and retaining the best people
                in the industry.</h3>
            <p align="justify">
                Bandhan Bank is the youngest bank in the industry, with a focus to build a youthful,
                enthusiastic and professional team determined to accomplish our <a href="">
                    vision</a> aligned with our core <a href="">values</a>.
                We are always looking to hire self-motivated individuals who are passionate about
                their careers. If you have a high sense of service orientation, ethical standards,
                professional integrity, corporate governance and regulatory compliance at all times,
                then we are looking forward to making you a part of our team.</p>
            <p align="justify">
                If that sounds like you, apply directly for a suitable opening by filling in the
                form below.<br />
                Also watch out for <a href="">
                    fraudulent recruitment offers.</a></p>
</div>
</div>
</div>
<div class="container ">
...
<div class="form-group">
 ...
 <option value="Experienced">Experienced</option>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Position applied for*</label>
 <select name="position_for" id="" class="form-control">
 <option value="">Select Position</option>
 <option value="1">Administration</option>
		<option value="Agri Business">Agri Business</option>
		<option value="Analytics/BIU/Corporate Strategy">Analytics/BIU/Corporate Strategy</option>
		<option value="Audit">Audit</option>
		<option value="Banking Operations&amp;Customer Services">Banking Operations&amp;Customer Services</option>
		...
		<option value="Corporate Salary">Corporate Salary</option>
		<option value="Corporate Services">Corporate Services</option>
		<option value="Digital Banking">Digital Banking</option>
		<option value="Finance &amp; Accounts">Finance &amp; Accounts</option>
		<option value="Human Resources">Human Resources</option>
		<option value="IT">IT</option>
		<option value="Legal/Vigilance">Legal/Vigilance</option>
		<option value="Micro Banking">Micro Banking</option>
		<option value="Retail Assets">Retail Assets</option>
		<option value="Risk">Risk</option>
		<option value="SME &amp; MSME Banking">SME &amp; MSME Banking</option>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Location/District</label>
